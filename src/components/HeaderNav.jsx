...
//       {/*  MAIN HEADER NAVBAR  */}
//       <header
//         className={`fixed top-0 -left-3 sm:left-0 w-full z-50 select-none transition-all duration-500 ease-out ${
...
//             <a href="#top" className="flex items-center order-1">
//               <img
//                 src={logoImage}
//                 alt="Studio DNA Logo"
...
//             <a href="#top" onClick={() => setIsMenuOpen(false)} className="flex items-center">
//               <img
//                 src={logo2Image}
//                 alt="Studio DNA Logo"
//                 className="h-18 sm:h-16 md:h-20 -ml-4 w-auto object-contain mix-blend-multiply"
...
//             <nav className="flex flex-col space-y-2 sm:space-y-3 md:space-y-6 -mt-30 sm:-mt-7">
    ...
    <>
      ...
      >
        <div className="flex flex-col justify-between min-h-full w-full max-w-[1920px] mx-auto gap-8">
          {/* Top bar inside the fullscreen menu */}
          <div className="w-full flex items-center justify-between">
            <a href="#top" onClick={handleMenuItemClick} className="flex items-center">
              <img
                src={logo2Image}
                alt="Studio DNA Logo"
                className="h-18 sm:h-16 md:h-20 -ml-4 w-auto object-contain mix-blend-multiply"
