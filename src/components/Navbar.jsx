...
//             <a
//               href="#consultation"
//               className="w-full md:w-auto inline-flex items-center justify-between gap-6 border border-white px-4 py-3 text-[12px] font-bold tracking-[0.25em] uppercase text-white bg-[#
//               ] hover:bg-white hover:text-[#4f5d39] transition-all duration-500 transform hover:-translate-y-0.5 -mt-15"
