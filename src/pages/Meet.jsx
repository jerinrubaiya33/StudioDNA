...
//   return (
//     <section className="relative z-10 -mt-7 mb-20 w-full px-4 sm:px-6 md:px-12 lg:px-16 py-20 bg-[#f5f2ea] rounded-4xl text-neutral-800 space-y-24">
    ...
    <section className="relative z-10 -mt-7 mb-20 w-full px-4 sm:px-6 md:px-12 lg:px-16 py-10 md:py-20 bg-[#f5f2ea] rounded-3xl md:rounded-4xl text-neutral-800 space-y-12 md:space-y-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-7 mt-0 lg:-mt-10 bg-neutral-50 p-4 sm:p-6 rounded-2xl border border-neutral-100 shadow-sm">
          <div className="mb-4">
            <h4 className="font-serif text-base sm:text-lg font-medium text-neutral-900">
              Select a Date & Time
            </h4>
            <p className="text-xs text-neutral-500">
              Pick a slot below that works perfectly for your schedule.
